...
``` shell
docker run philsturgeon/speccy lint https://raw.githubusercontent.com/OAI/OpenAPI-Specification/master/examples/v3.0/petstore.yaml
```
...
docker run \
  ...
  philsturgeon/speccy lint openapi.yaml
```
